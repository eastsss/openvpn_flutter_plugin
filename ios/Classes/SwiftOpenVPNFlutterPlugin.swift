...
public class SwiftOpenVPNFlutterPlugin: NSObject, FlutterPlugin {
    ...
    private static var EVENT_CHANNEL_VPN_STAGE : String = "com.polecat.openvpn_flutter/vpnstage"
    private static var METHOD_CHANNEL_VPN_CONTROL : String = "com.polecat.openvpn_flutter/vpncontrol"
